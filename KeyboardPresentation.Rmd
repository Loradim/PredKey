---
title: "PredKey<br>Type faster - finish early"
author: "Heiko Lange"
...
- PredKey works both with <span style="color:blue"><b>ngrams</b></span> (looking the the words typed before) and taking into account the <span style="color:blue"><b>partial word</b></span> the user already has typed
...
## PredKey in <span style="color:red"><b>torture</b></span> scenario
...
* PredKey App online: <https://loradim.shinyapps.io/PredKey>
  (Please be aware that the server is a bit slow - predictions might be a bit laggy - locally it runs much better)

* PredKey pitch: <https://github.com/Loradim/PredKey>
